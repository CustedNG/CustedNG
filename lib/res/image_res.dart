...
class ImageRes {
  ...
  static const manageIcon = AssetImage('assets/icon/manage.png');
  static const runningIcon = AssetImage('assets/icon/running.png');
  static const rssIcon = AssetImage('assets/icon/rss.png');
  static const mapIcon = AssetImage('assets/icon/map.png');
  static const thermometerIcon = AssetImage('assets/icon/thermometer.png');
  static const runningReportIcon = AssetImage('assets/icon/running_report.png');
  ...
  static const miscSchoolCalendar =
      AssetImage('assets/calendar/2020-2021-1.png');
